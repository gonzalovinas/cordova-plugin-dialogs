...
public class Notification extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        else if (action.equals("promptNumericPassword")) {
            this.promptNumericPassword(args.getString(0), args.getString(1), args.getJSONArray(2), args.getString(3), callbackContext);
            return true;
        }
    ...
    public synchronized void promptNumericPassword(final String message, final String title, final JSONArray buttonLabels, final String defaultText, final CallbackContext callbackContext) {
